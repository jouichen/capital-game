...
// 獨立地理資料庫：終極相容純文字版（100% 解決國旗圖案跑不出來的問題）
const MODES = { 
    TODDLER: { 
        speed: 2100, duration: 40000, penalty: 0, size: '20px', switchProb: 0,
        themes: {
            ASIA: { n: "🗾 亞洲經典組", text: "🎯 任務：請點擊正確的國家首都！", pool: [{e:'【台灣】台北', t:true}, {e:'【日本】東京', t:true}, {e:'【韓國】首爾', t:true}, {e:'【泰國】曼谷', t:true}, {e:'羅馬', t:false}, {e:'雪梨', t:false}], c: '#475569' },
    ...
    CHILD: { 
        ...
        themes: {
            ...
            EUROPE: { 
                ...
                pool_rabbit: [{e:'【美國】華盛頓', t:true}, {e:'【加拿大】渥太華', t:true}, {e:'【澳洲】堪培拉', t:true}, {e:'【土耳其】安卡拉', t:true}, {e:'紐約', t:false}, {e:'雪梨', t:false}, {e:'伊斯坦堡', t:false}], 
                c: '#1d4ed8' 
            }
        }
    },
    SENIOR: { 
        ...
        themes: {
            ...
            WORLD: { n: "🌍 樂齡環球大腦操", text: "👵 請注意：美國首都是華盛頓不是紐約喔！", pool_squirrel: [{e:'【美國】華盛頓', t:true}, {e:'【加拿大】渥太華', t:true}, {e:'紐約', t:false}], pool_rabbit: [{e:'【澳洲】堪培拉', t:true}, {e:'【法國】巴黎', t:true}, {e:'雪梨', t:false}], c: '#0f766e' }
        }
    }
};
    ...
    if (currentModeType === 'TODDLER') {
        ...
        if (currentModeType === 'CHILD') {
            ...
            if (currentThemeKey === 'EUROPE') {
                inst.innerHTML = isSquirrel ? "🔴 【歐洲國家】指令：抓出 歐洲各國正統首都！" : "🔵 【世界大國】指令：抓出 美/加/澳/土耳其首都！";
            }
            levelInd.innerText = "⚠️ 提示：前面沒有寫【國家】的城市（如雪梨、紐約）都是假的！";
            ...
            if (currentThemeKey === 'WORLD') inst.innerHTML = isSquirrel ? "大腦體操 🚨 美國首都是華盛頓喔" : "大腦體操 🚨 澳洲首都是堪培拉喔";
