...
const MODES = { 
    TODDLER: { 
        ...
        themes: {
            ...
            NORDIC: { n: "❄️ 北歐極光組", text: "🎯 任務：請點擊正確的北歐國家首都！", pool: [{e:'【丹麥】哥本哈根', t:true}, {e:'【芬蘭】赫爾辛基', t:true}, {e:'【挪威】奧斯陸', t:true}, {e:'【瑞典】斯德哥爾摩', t:true}, {e:'羅瓦涅米', t:false}, {e:'卑爾根', t:false}], c: '#0f766e' }
        }
    },
    CHILD: { 
        ...
        themes: {
            ...
            NORDIC: {
                n: "❄️ 北歐五國限時特訓",
                text: "任務：聽從極光指令抓出正確的北歐首都！",
                pool_squirrel: [{e:'【丹麥】哥本哈根', t:true}, {e:'【芬蘭】赫爾辛基', t:true}, {e:'【冰島】雷克雅維克', t:true}, {e:'羅瓦涅米', t:false}, {e:'聖誕老人村', t:false}],
                pool_rabbit: [{e:'【挪威】奧斯陸', t:true}, {e:'【瑞典】斯德哥爾摩', t:true}, {e:'卑爾根', t:false}, {e:'哥特堡', t:false}],
                c: '#0369a1'
            },
            AMERICA_AFRICA: {
                n: "🦁 美洲與非洲特訓營",
    ...
    SENIOR: { 
        ...
        themes: {
            ...
            NORDIC: { n: "❄️ 樂齡漫步北歐", text: "👵 請注意：芬蘭首都是赫爾辛基，不是聖誕老人村喔！", pool_squirrel: [{e:'【丹麥】哥本哈根', t:true}, {e:'【芬蘭】赫爾辛基', t:true}, {e:'聖誕老人村', t:false}], pool_rabbit: [{e:'【挪威】奧斯陸', t:true}, {e:'【瑞典】斯德哥爾摩', t:true}, {e:'卑爾根', t:false}], c: '#0f766e' },
            WORLD_A: { n: "🌍 樂齡環球大腦操 (歐美)", text: "👵 請注意：美國首都是華盛頓、加拿大是渥太華喔！", pool_squirrel: [{e:'【美國】華盛頓', t:true}, {e:'【加拿大】渥太華', t:true}, {e:'紐約', t:false}, {e:'多倫多', t:false}], pool_rabbit: [{e:'【英國】倫敦', t:true}, {e:'【法國】巴黎', t:true}, {e:'曼徹斯特', t:false}], c: '#115e59' },
            WORLD_B: { n: "🦘 樂齡環球大腦操 (紐澳非)", text: "👵 請注意：澳洲首都是堪培拉、巴西是巴西利亞喔！", pool_squirrel: [{e:'【澳洲】堪培拉', t:true}, {e:'【紐西蘭】威靈頓', t:true}, {e:'雪梨', t:false}, {e:'奧克蘭', t:false}], pool_rabbit: [{e:'【巴西】巴西利亞', t:true}, {e:'【南非】普利托利亞', t:true}, {e:'聖保羅', t:false}, {e:'開普敦', t:false}], c: '#134e4a' }
        }
    }
};
    ...
    if (currentModeType === 'TODDLER') {
        ...
        if (currentModeType === 'CHILD') {
            ...
            if (currentThemeKey === 'NORDIC') {
                inst.innerHTML = isSquirrel ? "🔴 【千湖與冰島】指令：快抓 丹麥/芬蘭/冰島首都！" : "🔵 【斯堪地那維亞】指令：快抓 挪威/瑞典首都！";
            }
            ...
            levelInd.innerText = "⚠️ 提示：前面沒有標【國家】的城市（如羅瓦涅米、卑爾根）都是假的！";
            ...
            if (currentThemeKey === 'NORDIC') inst.innerHTML = isSquirrel ? "大腦體操 🚨 芬蘭首都是赫爾辛基喔" : "大腦體操 🚨 挪威首都是奧斯陸喔";
...
function nextTurn() {
    ...
    const maxX = Math.max(10, stageWidth - 170); 
